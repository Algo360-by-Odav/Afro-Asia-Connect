...
router.get('/recent-activity', authenticateToken, async (req, res) => {
  try {
    ...
    // Return mock activities for now since many tables don't exist
    const mockActivities = [
      {
        id: 'activity-1',
        type: 'booking',
        text: 'New booking received for Photography Service',
      ...
      },
      {
        id: 'activity-3',
        type: 'lead',
        text: 'New inquiry: Business Partnership Opportunity',
      ...
      },
      {
        id: 'activity-4',
        type: 'booking',
        text: 'Booking confirmed for Consulting Service',
      ...
      },
      {
        id: 'activity-5',
        type: 'message',
        text: 'Sent message to Jane Smith',
