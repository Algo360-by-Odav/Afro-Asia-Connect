...
router.post('/login', async (req, res) => {
  console.log('[AUTH] Login request received:', { email: req.body.email, hasPassword: !!req.body.password });
  ...
  try {
    ...
    console.log('[AUTH] User found:', !!user, user ? `ID: ${user.id}, Active: ${user.isActive}` : 'null');
