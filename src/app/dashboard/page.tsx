  ...
  return (
    <div className="flex flex-1 min-h-[calc(100vh-120px)]">
      ...
      <main className="flex-1 p-6 sm:p-8 lg:p-10 overflow-y-auto bg-slate-50">
        ...
        {user && (user.role === 'member' || user.user_type === 'member') && (
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-yellow-800">
                  Account Role Needs Update
                </h3>
                <div className="mt-2 text-sm text-yellow-700">
                  <p>
                    Your account role is set to "member" but you may have registered as a service provider or seller. 
                    <Link href="/dashboard/fix-role" className="font-medium underline hover:text-yellow-600 ml-1">
                      Click here to update your role
                    </Link>
                  </p>
                </div>
              </div>
